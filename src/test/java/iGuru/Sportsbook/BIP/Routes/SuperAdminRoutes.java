...
//		public static String local="http://192.168.1.7:5000/api";
		...
		//AdminUser
		public static String getadminuser = base_url+"/admin/adminuser/get/3";
		public static String adminuserlist = base_url+"/admin/adminuser/list";
		public static String addAdminuser = base_url+"/admin/adminuser/add";
		public static String updateadminuser = base_url+"/admin/adminuser/update";
		public static String deleteadminuser = base_url+"/admin/adminuser/delete";
		
		//System Setting
		public static String getsystemsetting = base_url+"/admin/system/setting/list";
		public static String updatesystemsetting = base_url+"/admin/system/setting/update";
		
		//League
		public static String SelectedTopleague = base_url+"/admin/topleagues/selected";
		public static String getleague = base_url+"/admin/leagues/get";
		public static String updatetopleague = base_url+"/admin/topleagues/update";
