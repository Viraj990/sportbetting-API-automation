...
//		public static String local="http://192.168.1.7:5000/api";
		...
		public static String getprematchdetails=base_url+"/auth/prematch/fixtures/detail/{FixtureID}";
		...
		public static String GetTopLeagueDetail=base_url+"/auth/topleagues/detail/8";
